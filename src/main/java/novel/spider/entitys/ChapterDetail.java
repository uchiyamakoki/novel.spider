...
public class ChapterDetail implements Serializable {
	...
	public String toString() {
		return "ChapterDetail [title=" + title + ", content=" + StringUtils.abbreviate(content, 30)
				+ ", prev=" + prev + ", next=" + next + "]";
	}
	 ...
	 * public static void main(String[] args) {
		...
		chapterDetail.setContent("池瑶，我待你如挚爱，你为何要杀我？张若尘大吼一声，想前一扑，压得鎏金铸造的床榻“咯吱”一声，猛然坐了起来。");
